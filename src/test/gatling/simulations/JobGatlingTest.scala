...
class JobGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Job entity")
        ...
        .repeat(2) {
            ...
            .put("/api/jobs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "responsibilities":"SAMPLE_TEXT", "requirements":"SAMPLE_TEXT", "postDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
